...
public class sha1 {
	...
	public static String calculateMod(String word, String binary) {
		...
		return createMessageLength(binary, onePadded, binaryZeros, endBitLength); //creates the 512 bit message
